...
/* harmony import */ var cozy_clisk_dist_contentscript_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30);
/* harmony import */ var _cozy_minilog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
...
/* harmony import */ var ky_umd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
...
/* harmony import */ var p_wait_for__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29);
...
class EngieContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
  ...
  async downloadFileInWorker(entry) {
    if (entry.method === 'post') {
      ...
      entry.blob = await ky_umd__WEBPACK_IMPORTED_MODULE_4___default().post(entry.fileurl, { body: searchParams }).blob()
      entry.dataUri = await (0,cozy_clisk_dist_contentscript_utils__WEBPACK_IMPORTED_MODULE_1__.blobToBase64)(entry.blob)

      return entry.dataUri
    } else {
      entry.blob = await ky_umd__WEBPACK_IMPORTED_MODULE_4___default().get(entry.fileurl).blob()
      entry.dataUri = await (0,cozy_clisk_dist_contentscript_utils__WEBPACK_IMPORTED_MODULE_1__.blobToBase64)(entry.blob)
